...
* 使用[xray](https://github.com/XTLS/Xray-core)+caddy同时部署通过ws传输的vless等协议。
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 域名即为heroku分配域名，格式为`xxx.herokuapp.com`，用于客户端  
  * 默认协议密码UUID为`24b4b1e1-7a89-45f6-858c-242cf53b5bdb`
...
* 插件选项: tls;host=xxx.herokuapp.com;path=/
```
</details>
